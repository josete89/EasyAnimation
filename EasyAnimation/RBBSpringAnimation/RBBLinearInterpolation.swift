...
class RBBInterpolator
{
    ...
    fileprivate static func RBBInterpolateCATransform3D(_ from: CATransform3D, to: CATransform3D) -> RBBLinearInterpolation
    {
    ...
    fileprivate static func RBBInterpolateCGRect(_ from: CGRect, to: CGRect) -> RBBLinearInterpolation
    {
    ...
    fileprivate static func RBBInterpolateCGPoint(_ from: CGPoint, to: CGPoint) -> RBBLinearInterpolation
    {
    ...
    fileprivate static func RBBInterpolateCGSize(_ from: CGSize, to: CGSize) -> RBBLinearInterpolation
    {
    ...
    fileprivate static func RBBInterpolateCGFloat(_ from: CGFloat, to: CGFloat) -> RBBLinearInterpolation
    {
        let delta = to - from
    ...
    fileprivate static func RBBInterpolateUIColor(_ from: UIColor, to: UIColor) -> RBBLinearInterpolation
    {
